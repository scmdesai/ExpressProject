...
exports.findDealsById = function(req, res) {
	//console.log("GET STORES") ;
...
exports.deleteDeal = function(req, res) {
	...
	simpleDB.deleteAttributes(params, function(err, data) {
		...
		if (err) {
			...
			res.status(200).send('<script type=\"text/javascript\"> alert("Deal deleted successfully");window.open("", "popupWindow", ",width=600,height=600,).document.write(\'Test\')</script>');
		}
	});
