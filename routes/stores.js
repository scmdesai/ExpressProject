...
exports.findAllStores = function(req, res, next) {
	...
	//if query is for one customer
	if(req.query.customerId){
		var	params = {
			SelectExpression: 'select * from MyCustomers where customerId='+customerId+'SignupStatus="Approved"', /* required */
			ConsistentRead: true
